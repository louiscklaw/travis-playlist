...
def test_filterOutPreMergeBranch():
  fail_reason = 'filterOutPreMergeBranch'
  test_result = filterOutPreMergeBranch('/pre-merge/1')
  assert False==test_result, fail_reason
  return False

def test_filterOutPreMergeMasterBranch():
  fail_reason = 'test_filterOutPreMergeMasterBranch'
  test_result = filterOutPreMergeMasterBranch('/pre-merge-master')
  assert False==test_result, fail_reason
  return False
...
def test_filterAutoGeneratedBranch():
  fail_reason="test_filterAutoGeneratedBranch"
  result = filterAutoGeneratedBranch([
    'HEAD',
    '/master',
    '/develop',
    'gh-pages',
    '/pre-merge-master',
    '/pre-merge/user-test1',
    '/feature/user-test1',
    'origin/test/fix-load-page'
  ])

  assert sorted(['/pre-merge-master','/pre-merge/user-test1','/feature/user-test1'])==result, fail_reason
...
if __name__ == "__main__":
  ...
  test_filterOutPreMergeMasterBranch()
  test_filterOutPreMergeBranch()
  test_getDayDifference()
  test_shouldDeleteBranch()
  test_filterAutoGeneratedBranch()